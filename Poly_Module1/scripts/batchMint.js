...
async function main() {
  ...
  const contractAddress = "0xAb45f4c1C0a7083F45E3e62b07864E9491240ADF";

  // Get the contract factory and attach it to the signer
  const POLYNFT = await ethers.getContractFactory("POLY_ETH", signer);
  const contract = await POLYNFT.attach(contractAddress);
