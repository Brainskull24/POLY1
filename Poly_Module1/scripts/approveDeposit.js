...
const ABI = require('../artifacts/contracts/POLY_ETH.sol/POLY_ETH.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("POLY_ETH");
  const nft = await NFT.attach('0xAb45f4c1C0a7083F45E3e62b07864E9491240ADF');
  ...
  console.log("POLYNFT wallet balance", wallet.address, "is: ", balance.toString());
}
